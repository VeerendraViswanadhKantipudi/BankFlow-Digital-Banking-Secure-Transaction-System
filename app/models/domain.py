...
class AuditEventType(str, enum.Enum):
    ...
    ACCOUNT_CREATED_IDEMPOTENT_REPLAY = "ACCOUNT_CREATED_IDEMPOTENT_REPLAY"
    ACCOUNT_STATUS_CHANGED = "ACCOUNT_STATUS_CHANGED"
    DEPOSIT_COMPLETED = "DEPOSIT_COMPLETED"
    DEPOSIT_IDEMPOTENT_REPLAY = "DEPOSIT_IDEMPOTENT_REPLAY"
    TRANSFER_COMPLETED = "TRANSFER_COMPLETED"
    RECONCILIATION_RUN = "RECONCILIATION_RUN"
    BRANDING_UPDATED = "BRANDING_UPDATED"
    FREEZE_REQUESTED = "FREEZE_REQUESTED"
    FREEZE_REQUEST_REVIEWED = "FREEZE_REQUEST_REVIEWED"
